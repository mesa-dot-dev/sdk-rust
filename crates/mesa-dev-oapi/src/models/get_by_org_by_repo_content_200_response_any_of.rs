...
impl GetByOrgByRepoContent200ResponseAnyOf {
    pub fn new(r#type: Type, name: Option<String>, path: Option<String>, sha: Option<String>, size: f64, encoding: Encoding, content: Option<String>, executable: bool, last_commit_at: Option<String>) -> GetByOrgByRepoContent200ResponseAnyOf {
