...
/// struct for typed errors of method [`delete_by_org_api_keys_by_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteByOrgApiKeysByIdError {
...
/// struct for typed errors of method [`get_by_org_api_keys`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetByOrgApiKeysError {
    Status400(models::GetByOrgApiKeys400Response),
    Status401(models::GetByOrgApiKeys400Response),
    Status403(models::GetByOrgApiKeys400Response),
    Status404(models::GetByOrgApiKeys400Response),
    Status406(models::GetByOrgApiKeys400Response),
    Status409(models::GetByOrgApiKeys400Response),
    Status500(models::GetByOrgApiKeys400Response),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`post_by_org_api_keys`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PostByOrgApiKeysError {
    Status400(models::PostByOrgApiKeys400Response),
    Status401(models::PostByOrgApiKeys400Response),
    Status403(models::PostByOrgApiKeys400Response),
    Status404(models::PostByOrgApiKeys400Response),
...
pub async fn delete_by_org_api_keys_by_id(configuration: &configuration::Configuration, id: &str, org: &str) -> Result<models::DeleteByOrgApiKeysById200Response, Error<DeleteByOrgApiKeysByIdError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteByOrgApiKeysByIdError> = serde_json::from_str(&content).ok();
...
pub async fn get_by_org_api_keys(configuration: &configuration::Configuration, org: &str) -> Result<models::GetByOrgApiKeys200Response, Error<GetByOrgApiKeysError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetByOrgApiKeysError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn post_by_org_api_keys(configuration: &configuration::Configuration, org: &str, post_by_org_api_keys_request: Option<models::PostByOrgApiKeysRequest>) -> Result<models::PostByOrgApiKeys201Response, Error<PostByOrgApiKeysError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostByOrgApiKeysError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
